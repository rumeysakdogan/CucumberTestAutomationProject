...
public class Driver {
    ...
    //to make thread safe either you can make the method synchronized or we can create synchronized block
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {
            ...
            synchronized (Driver.class) {
                ...
                // if environment was specified
                if (System.getProperty("browser") != null) {
                    // then change browser type
                    // regardless on value configuration.properties
                    System.out.println("Browser type was changed to: " + System.getenv("browser"));
